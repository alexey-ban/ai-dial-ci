...
jobs:
  run_tests:
    uses: alexey-ban/ai-dial-ci/.github/workflows/node_pr.yml@main
    secrets: inherit
```
...
jobs:
  release:
    uses: alexey-ban/ai-dial-ci/.github/workflows/node_release.yml@main
    secrets: inherit
```
...
jobs:
  run_tests:
    uses: alexey-ban/ai-dial-ci/.github/workflows/java_pr.yml@main
    secrets: inherit
```
...
jobs:
  release:
    uses: alexey-ban/ai-dial-ci/.github/workflows/java_release.yml@main
    secrets: inherit
```
...
jobs:
  run_tests:
    uses: alexey-ban/ai-dial-ci/.github/workflows/python_docker_pr.yml@main
    secrets: inherit
```
...
jobs:
  release:
    uses: alexey-ban/ai-dial-ci/.github/workflows/python_docker_release.yml@main
    secrets: inherit
```
...
jobs:
  run_tests:
    uses: alexey-ban/ai-dial-ci/.github/workflows/python_package_pr.yml@main
    secrets: inherit
```
...
jobs:
  release:
    uses: alexey-ban/ai-dial-ci/.github/workflows/python_package_release.yml@main
    secrets: inherit
```
...
jobs:
  run_tests:
    uses: alexey-ban/ai-dial-ci/.github/workflows/generic_docker_pr.yml@main
    secrets: inherit
```
...
jobs:
  release:
    uses: alexey-ban/ai-dial-ci/.github/workflows/generic_docker_release.yml@main
    secrets: inherit
```
            ...
            [
              {
                ...
                "repository": "alexey-ban/ai-dial-ci",
                "static_args": [
